      ...
      <div id="primary_menu" class="z-20" data-aos="fade-left">
        <div class="lg:hidden">
          <a href="#" aria-label="Toggle navigation" id="primary-menu-toggle">
            ...
            <svg class="close-icon hidden inline-block w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="#000000"
                 viewBox="0 0 30 30">
              <path
        ...
        <ul class="list-none hidden lg:flex">
          ...
          <li class="wp-menu-item relative ml-5">
            <a href="https://hub.ezptz.no/" class="text-base bg-primary hover:bg-secondary text-white py-3 px-6 rounded uppercase block">
              Sign In
            </a>
          </li>
        </ul>
    ...
    <div class="mobile-primary-menu z-20 hidden">
      <ul>
        ...
        <li class="wp-menu-item">
          <a href="https://hub.ezptz.no/" class="text-base text-primary flex relative py-4 uppercase border-b border-gray-200">
            Sign In
          </a>
        </li>
      </ul>
